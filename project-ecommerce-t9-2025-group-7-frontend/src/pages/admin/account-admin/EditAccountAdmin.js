...
const EditAccountAdmin = () => {
  ...
  const fetchAccount = async () => {
    try {
      ...
      const res = await axios.get(`${DOMAIN_SERVER}/admin/account/${id}`, {
        params: params
      });
      ...
      if (res.data.success && res.data.data) {
        ...
        setFormData({
          ...
          phone: account.phone || '',
          password: '',
          role: account.role ? account.role._id : '',
        ...
        await Swal.fire({
          icon: 'error',
          title: 'Lỗi!',
          text: res.data.message || 'Không thể tải thông tin tài khoản',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.patch(`${DOMAIN_SERVER}/admin/account/${id}`, submitData);
      
      if (res.data.success === true) {
        await Swal.fire({
          icon: 'success',
          title: 'Thành công!',
          text: 'Tài khoản quản trị đã được cập nhật thành công',
          confirmButtonText: 'OK',
      ...
      await Swal.fire({
        icon: 'error',
        title: 'Lỗi!',
        text: error.response?.data?.message || 'Có lỗi xảy ra khi cập nhật tài khoản. Vui lòng thử lại.',
        confirmButtonText: 'OK',
        confirmButtonColor: '#dc3545'
      });
    } finally {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-white px-6 py-8 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Cập nhật tài khoản quản trị</h2>
            <p className="text-gray-600">Chỉnh sửa thông tin tài khoản quản trị</p>
          </div>
