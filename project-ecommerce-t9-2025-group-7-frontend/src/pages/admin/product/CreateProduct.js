...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${DOMAIN_SERVER}/admin/product/create`, formDataToSend, {
        headers: {
      ...
      if (res.data.success === true) {
        ...
        await Swal.fire({
          icon: 'error',
          title: 'Lỗi!',
          text: res.data.message || 'Thêm sản phẩm thất bại',
          confirmButtonText: 'OK',
          confirmButtonColor: '#dc3545'
        });
      }
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-white px-6 py-8 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Thêm mới sản phẩm</h2>
            <p className="text-gray-600">Nhập thông tin sản phẩm mới</p>
          </div>
